...
# TODO. HARDCODED, it shouls be generated by requesting the instances //see: script-slapos-request.py
server_url_list = [
...
while len(combination_list) > 0:
  ...
  while not assigned:
    ...
    if driver_dict:
      assigned = True
      print("combination assigned to free driver. running driver combination")
      try:
