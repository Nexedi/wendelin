...
class PandasInventoryTest(ERP5TypeLiveTestCase):
  """
  A Sample Test Class
  """
  ...
  def test_01_fillBigArrayTest(self):
    ...
    self.portal.portal_skins.erp5_wendelin_inventory.Base_convertResultsToBigArray(
      data,
      title='Testing - Fill Big Array'
    )
    transaction.commit()
    self.tic()
    
    data_array = self.portal.portal_catalog(portal_type='Data Array', title='Testing - Fill Big Array')[0].getObject()
  ...
  def test_02_extendBigArrayTest(self):
    ...
    self.portal.portal_skins.erp5_wendelin_inventory.Base_convertResultsToBigArray(
      data,
      title='Testing - Extend Big Array'
    )
    transaction.commit()
    self.tic()
    
    data_array = self.portal.portal_catalog(portal_type='Data Array', title='Testing - Extend Big Array')[0].getObject()
  ...
  def test_04_getMovementHistoryListTest(self):
    ...
    self.portal.portal_skins.erp5_wendelin_inventory.Base_convertResultsToBigArray(
      data,
      title='Testing - getMovementHistoryList'
    )
    transaction.commit()
    self.tic()
    
    result = self.portal.portal_catalog(portal_type='Data Array', title='Testing - getMovementHistoryList')
    self.assertTrue(len(result) != 0)
    
    df = self.portal.portal_skins.erp5_wendelin_inventory.Base_filterInventoryDataFrame(
      is_accountable=True,
      resource_uid=resource_uid,
      data_array_title='Testing - getMovementHistoryList'
    )
