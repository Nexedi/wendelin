...
class TestDataIngestion(SecurityTestCase):
  ...
  def afterSetUp(self):
    self.assertEqual(self.REFERENCE_SEPARATOR, self.portal.DataLake_getIngestionReferenceDictionary()["reference_separator"])
    self.assertEqual(self.INVALID, self.portal.DataLake_getIngestionReferenceDictionary()["invalid_suffix"])
    self.assertEqual(self.EOF, self.REFERENCE_SEPARATOR + self.portal.DataLake_getIngestionReferenceDictionary()["split_end_suffix"])
    self.assertEqual(self.PART_1, self.REFERENCE_SEPARATOR + self.portal.DataLake_getIngestionReferenceDictionary()["split_first_suffix"])
