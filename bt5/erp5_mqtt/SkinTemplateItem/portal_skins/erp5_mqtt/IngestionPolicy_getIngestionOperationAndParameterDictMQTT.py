...
#input_line.setAggregateSet(input_line.getAggregateList() + operation_line.getAggregateList())
...
context.log("I am now here ...")

# mqtt_message.validate()
...
return data_operation, {'data_stream': None}
